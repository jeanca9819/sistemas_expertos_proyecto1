...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="index.php">Paquetes</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?c=mapa&a=mapaAction">Mapa del sitio</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?c=nosotros&a=nosotrosAction">Nosotros</a></li>
                    </ul>
                </div>
            </div>
        </nav>